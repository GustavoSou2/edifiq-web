...
@Component({
  selector: 'edq-settings-categories',
  standalone: true,
  ...
  template: `
    ...
    <div class="settings-layout">
      <nav class="settings-nav" aria-label="Navegação de configurações">
        ...
        <a class="settings-nav__link" routerLink="../categories" routerLinkActive="settings-nav__link--active">Categorias</a>
      ...
      <div class="settings-content">
        <section class="settings-section">
          <div class="section-header">
            <div>
              <h2 class="settings-section__title">Categorias de Materiais</h2>
              <p class="settings-section__desc">Organize os materiais por categoria para facilitar a busca dos fornecedores.</p>
            </div>
            <edq-button variant="primary" size="sm" (clicked)="openCreate()">
              + Nova Categoria
            </edq-button>
          </div>
                  ...
                  <div class="cat-row cat-row--root">
                    <div class="cat-row__info">
                      ...
                      @if (cat.children?.length) {
                        <span class="cat-count">{{ cat.children!.length }} subcategorias</span>
                      }
                    </div>
        ...
        <div class="modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal__body">
            ...
            <edq-input
              ...
              [(value)]="form.slug"
            />
            <p class="field-hint">Gerado automaticamente a partir do nome. Use apenas letras minúsculas, números e hífens.</p>
          </div>
    ...
    try {
      if (this.editingId()) {
        await firstValueFrom(
          this.categoriesApi.update(this.editingId()!, {
            name: this.form.name,
            slug: this.form.slug,
          })
        );
