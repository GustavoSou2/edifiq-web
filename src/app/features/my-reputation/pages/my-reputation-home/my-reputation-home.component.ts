...
const MOCK_REVIEWS: Review[] = [
  { id: 'r1', buyerName: 'Construtora Alpha', orderRef: '#EDQ-2024-0041', rating: 5, comment: 'Entrega no prazo, material de excelente qualidade. Recomendo!',                  createdAt: '2024-01-14T10:00:00Z' },
  { id: 'r2', buyerName: 'Obras Beta Ltda',   orderRef: '#EDQ-2024-0038', rating: 4, comment: 'Boa entrega, apenas um pequeno atraso de 30 minutos. Material conforme pedido.', createdAt: '2024-01-10T09:00:00Z' },
  { id: 'r3', buyerName: 'Engenharia Gama',   orderRef: '#EDQ-2024-0035', rating: 5, comment: 'Perfeito! Melhor fornecedor que já trabalhamos. Preço justo e entrega rápida.',   createdAt: '2024-01-05T08:00:00Z' },
  { id: 'r4', buyerName: 'Construtora Delta', orderRef: '#EDQ-2024-0030', rating: 3, comment: 'Material ok, mas a comunicação poderia ser melhor durante o processo.',           createdAt: '2023-12-28T07:00:00Z' },
  { id: 'r5', buyerName: 'Obras Épsilon',     orderRef: '#EDQ-2024-0025', rating: 5, comment: 'Excelente! Entrega antecipada e material de primeira qualidade.',                createdAt: '2023-12-20T06:00:00Z' },
  { id: 'r6', buyerName: 'Construtora Zeta',  orderRef: '#EDQ-2024-0020', rating: 4, comment: 'Muito bom. Preço competitivo e atendimento ágil.',                               createdAt: '2023-12-15T05:00:00Z' },
];
...
@Component({
  ...
  template: `
    <edq-page-header title="Reputação" subtitle="Avaliações e métricas de desempenho" />
          ...
          <div class="review-card">
            <div class="review-card__header">
              <div class="review-card__buyer-info">
                ...
                <div>
                  <div class="review-card__buyer-name">{{ r.buyerName }}</div>
                  <div class="review-card__order-ref">{{ r.orderRef }}</div>
                </div>
              </div>
              <div class="review-card__meta">
                ...
                <div class="review-card__date">{{ r.createdAt | date:'dd/MM/yyyy' }}</div>
              </div>
            </div>
